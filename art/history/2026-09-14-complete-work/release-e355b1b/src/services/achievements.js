...
export const ACHIEVEMENTS = [
  {
    id: 'first-light', icon: 'first-light',
    name: '첫 물방울', nameEn: 'First Droplet',
    desc: '첫 레벨을 클리어', descEn: 'Clear the first level',
    check: s => (s.stars[1] || 0) > 0
  },
  {
    id: 'dawn-woods', icon: 'dawn-woods',
    name: '물방울을 잇다', nameEn: 'Droplets Connected',
    desc: '1챕터 완주', descEn: 'Complete Chapter 1',
    check: (s, c) => c.chapterCleared(1)
  },
  {
    id: 'misty-deeps', icon: 'misty-deeps',
    name: '갈림길의 해답', nameEn: 'Both Paths Found',
    desc: '2챕터 완주', descEn: 'Complete Chapter 2',
    check: (s, c) => c.chapterCleared(2)
  },
  {
    id: 'starlit-garden', icon: 'starlit-garden',
    name: '세 가지 물빛', nameEn: 'Three Tints',
    desc: '3챕터 완주', descEn: 'Complete Chapter 3',
    check: (s, c) => c.chapterCleared(3)
  },
  {
    id: 'ancient-heart', icon: 'ancient-heart',
    name: '맞은편의 불빛', nameEn: 'Across the Pool',
    desc: '4챕터 완주', descEn: 'Complete Chapter 4',
    check: (s, c) => c.chapterCleared(4)
  },
  {
    id: 'no-hint-ten', icon: 'no-hint-ten',
    name: '스스로 찾은 길', nameEn: 'A Path of Your Own',
    desc: '힌트 없이 10레벨 클리어', descEn: 'Clear 10 levels without hints',
    check: (s, c) => c.noHintClears >= 10
  },
  {
    id: 'daily-first', icon: 'daily-first',
    name: '하루의 작은 발견', nameEn: "One Daily Discovery",
    desc: '일일 챌린지 첫 클리어', descEn: 'First daily puzzle cleared',
    check: s => Object.keys(s.daily).length >= 1
  },
  {
    id: 'daily-streak-3', icon: 'daily-streak-3',
    name: '세 날의 기록', nameEn: 'Three Days Together',
    desc: '일일 챌린지 3일 연속 클리어', descEn: 'Daily streak of 3 days',
    check: (s, c) => c.streak >= 3
  },
  {
    id: 'perfectionist', icon: 'perfectionist',
    name: '모든 물길의 빛', nameEn: 'Every Channel Alight',
