...
- `/tmp/ilyndrel-ancient-title-desktop-v2.png` — 1440×900
- `/tmp/ilyndrel-ancient-title-mobile-v2.png` — 390×844
- `/tmp/ilyndrel-ancient-title-short-v2.png` — 614×427
