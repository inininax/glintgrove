...
The following locally authored scripts are offered under the GNU General Public License, version 3 or (at your option) any later version:
...
The runtime release builder excludes this authoring directory entirely. If these scripts are published through the repository, preserve this notice, the source, and the GPL text. Blender itself and its bundled dependencies are not redistributed by this project.
